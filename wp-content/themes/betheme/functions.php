...
/**
 * @updated 1.0.0
 * Custom CSS for avanzo's internal pages
 */
/*
wp_register_style("custom", get_template_directory_uri() . "/css/avanzo-pages.css", '', '1.0.0');
wp_enqueue_style('custom');
wp_register_script("custom", get_template_directory_uri() . "/js/slick/slick.js", '', '1.0.0');
wp_enqueue_script('custom');
*/
wp_enqueue_style('general', get_template_directory_uri() . "/css/custom/general.css");
wp_enqueue_style('footer', get_template_directory_uri() . "/css/custom/footer.css");
wp_enqueue_style('logn', get_template_directory_uri() . "/css/custom/login.css");
wp_enqueue_style('personas', get_template_directory_uri() . "/css/custom/personas.css");
wp_enqueue_style('quienes-somos', get_template_directory_uri() . "/css/custom/quienes-somos.css");
wp_enqueue_style('empresas', get_template_directory_uri() . "/css/custom/empresas.css");
wp_enqueue_style('clientes', get_template_directory_uri() . "/css/custom/clientes.css");
wp_enqueue_style('frmulario', get_template_directory_uri() . "/css/custom/formulario.css");