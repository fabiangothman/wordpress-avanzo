...
<body <?php body_class(); ?>>
	...
	<div id="login_sctin">
		...
		<a href="#myModal" class="trigger-btn" data-toggle="modal">Action here to open modal</a>

		<div id="myModal" class="modal fade">
			<div class="modal-dialog modal-login">
				<div class="modal-content">
					<form action="http://3.133.128.42:4000" class="text-blueavanzo" method="post">
						...
						<div class="modal-body">				
							...
							<div class="form-group">
								<div class="clearfix">
									<label>Clave</label>
									<a href="#" class="pull-right text-muted"><small>¿Olvidó su clave?</small></a>
								</div>
						...
						<div class="modal-footer">
							<label class="checkbox-inline pull-left"><input type="checkbox"> Recordarme</label>
